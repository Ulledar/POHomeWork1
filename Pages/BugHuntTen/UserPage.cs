...
namespace POHomeWork1.Pages
{
    class UserPage : BaseTest
    {
        ...
        readonly string pageHeader = "Wellcome To Your Personal Road Assitance";
        readonly By header = By.XPath("//h1[contains(text(), 'Wellcome to your personal road assitance')]");
